...
//Just a minor temporary fix, to let us deploy some bounties without user submission, before the new ubounties contract is released. 
contract ERC20Basic {
...
contract ubountyCreator{
    ...
    function createSingleBounty(
        ...
        uint48 deadline
            ...
            ubounties[numUbounties].submissions[0].submissionString = "temporary placeholder submission";
            ubounties[numUbounties].submissions[0].submitterIndex = hunters[hunter];
